        ...
        <div className="grid">
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-800 font-medium mb-3">Eficiencia Turno</span>
                            <div className="text-1000 font-medium text-xl">80%</div>
                        </div>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-800 font-medium mb-3 ">Disponibilidad Turno</span>
                            <div className="text-1000 font-medium text-xl">60%</div>
                        </div>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-800 font-medium mb-3">Velocidad Turno</span>
                            <div className="text-1000 font-medium text-xl">90%</div>
                        </div>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-800 font-medium mb-3">Producto Terminado Turno</span>
                            <div className="text-1000 font-medium text-xl">1520 Piezas</div>
                        </div>
