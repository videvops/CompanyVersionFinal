...
const TablaMaquinas = ({ BotonesCabezal, ExportarRegistros, dt, products, selectedProducts, filters, setSelectedProducts, header, actionBodyTemplate }) => {
    const maquinasFicticios = [
        { id: 1, nombreProducto: "Producto 1", idPlanta: "planta 1", idEmpresa: "empresa 1", idLinea: "linea1", fechaModificación: "10-12-2004", idStatus: "activo", modificadoPor: "des1", fechaCreacion: "12-03-2022", idCreadoPor: "1" },
        { id: 2, nombreProducto: "Producto 2", idPlanta: "planta 2", idEmpresa: "empresa 2", idLinea: "linea2", fechaModificación: "12-03-2006", idStatus: "inactivo", modificadoPor: "des2", fechaCreacion: "10-10-2021", idCreadoPor: "2" },
        { id: 3, nombreProducto: "Producto 3", idPlanta: "planta 3", idEmpresa: "empresa 3", idLinea: "linea3", fechaModificación: "11-0planta 1-2007", idStatus: "pendiente", modificadoPor: "des3", fechaCreacion: "15-06-2019", idCreadoPor: "3" },
        { id: 4, nombreProducto: "Producto 4", idPlanta: "planta 4", idEmpresa: "empresa 4", idLinea: "linea4", fechaModificación: "23-11-2008", idStatus: "activo", modificadoPor: "des4", fechaCreacion: "09-02-2023", idCreadoPor: "4" },
    ];
    ...
    return (
        <div className="card">
            ...
            >
                ...
                <Column field="nombreProducto" header="Maquina" sortable style={{ minWidth: "16rem", textAlign: "center" }} />
