    ...
    return (
        <div className="card">
            ...
            >
                ...
                <Column field="idEstatus" header="ID Status " sortable style={{ minWidth: "16rem", textAlign: "center" }} />
                <Column field="estatus" header="ID Status " sortable style={{ minWidth: "16rem", textAlign: "center" }} />
                <Column field="idLinea" header="ID Linea" sortable style={{ minWidth: "16rem", textAlign: "center" }} />
                <Column field="linea" header="ID Linea" sortable style={{ minWidth: "16rem", textAlign: "center" }} />
