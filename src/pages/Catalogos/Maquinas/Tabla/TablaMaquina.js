    ...
    return (
        <div className="card">
            ...
            >
                ...
                <Column field="idStatus" header="ID Linea" sortable style={{ minWidth: "16rem", textAlign: "center" }} />
                ...
                <Column field="idEmpresa" header="ID Status " sortable style={{ minWidth: "16rem", textAlign: "center" }} />
            </DataTable>
        </div>
    );
};
